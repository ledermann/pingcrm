...
# Pagy.new or any of the #pagy controller methods
...
# Pagy.options[:page_key]    = 'page'                # default
...
# >> Pagy::Calendar::Year.options
# >> Pagy::Calendar::Quarter.options
# >> Pagy::Calendar::Month.options
# >> Pagy::Calendar::Week.options
# >> Pagy::Calendar::Day.options
#
...
# Data Hash: Provides the pagination data to Javascript frameworks like Vue.js, react.js, etc.
# See https://ddnexus.github.io/pagy/docs/api/pagy#data-hash
# Data hash is now integrated in the core, no require needed
# For performance reasons, you should explicitly set ONLY the data keys you use in the frontend
...
# set to false only if you want to make :limit_extra an opt-in option
# Pagy.options[:limit_extra] = false           # default true
# Pagy.options[:limit_key] = 'limit'           # default
# Pagy.options[:client_max_limit] = 100        # default

# Overflow extra: Allow for easy handling of overflowing pages
# See https://ddnexus.github.io/pagy/docs/extras/overflow
# Note: In Pagy 43.x, the default behavior matches the old :empty_page setting
# If you want to raise errors like the old behavior, set:
# Pagy.options[:raise_range_error] = true

# Trim extra: Remove the page=1 param from links
# See https://ddnexus.github.io/pagy/docs/extras/trim
# require 'pagy/extras/trim'
# set to false only if you want to make :trim_extra an opt-in option
# Pagy.options[:trim_extra] = false # default true

# Standalone extra: Use pagy in non Rack environment/gem
# See https://ddnexus.github.io/pagy/docs/extras/standalone
# require 'pagy/extras/standalone'
# Pagy.options[:request] = { url: 'http://www.example.com/subdir' }  # optional default
...
# set to false only if you want to make :jsonapi an opt-in option
